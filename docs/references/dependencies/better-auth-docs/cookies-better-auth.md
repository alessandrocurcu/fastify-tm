...
### [Custom Cookies](https://better-auth.com/docs/concepts/cookies#custom-cookies)
...
### [Cross Subdomain Cookies](https://better-auth.com/docs/concepts/cookies#cross-subdomain-cookies)
...
### [Secure Cookies](https://better-auth.com/docs/concepts/cookies#secure-cookies)
...
## [Safari, ITP, and Cross-Domain Setups](https://better-auth.com/docs/concepts/cookies#safari-itp-and-cross-domain-setups)
...
Safari treats `domainA.com` as a third-party and blocks its cookies. Which can result in sessions not persisting, `Set-Cookie` being ignored, users appearing logged out after login or auth working in Chrome but failing in Safari.
...
### [Using a Reverse Proxy](https://better-auth.com/docs/concepts/cookies#using-a-reverse-proxy)
...
#### [Example with Netlify](https://better-auth.com/docs/concepts/cookies#example-with-netlify)
...
#### [Example with Vercel](https://better-auth.com/docs/concepts/cookies#example-with-vercel)
...
### [Using a Shared Parent Domain](https://better-auth.com/docs/concepts/cookies#using-a-shared-parent-domain)
...
Learn more about cross-subdomain cookies in the [documentation above](https://better-auth.com/docs/concepts/cookies#cross-subdomain-cookies).

This avoids Safari treating the API as third-party.

[Edit on GitHub](https://github.com/better-auth/better-auth/blob/main/docs/content/docs/concepts/cookies.mdx)

### On this page

[Cookie Prefix](https://better-auth.com/docs/concepts/cookies#cookie-prefix)[Custom Cookies](https://better-auth.com/docs/concepts/cookies#custom-cookies)[Cross Subdomain Cookies](https://better-auth.com/docs/concepts/cookies#cross-subdomain-cookies)[Secure Cookies](https://better-auth.com/docs/concepts/cookies#secure-cookies)[Safari, ITP, and Cross-Domain Setups](https://better-auth.com/docs/concepts/cookies#safari-itp-and-cross-domain-setups)[Using a Reverse Proxy](https://better-auth.com/docs/concepts/cookies#using-a-reverse-proxy)[Example with Netlify](https://better-auth.com/docs/concepts/cookies#example-with-netlify)[Example with Vercel](https://better-auth.com/docs/concepts/cookies#example-with-vercel)[Using a Shared Parent Domain](https://better-auth.com/docs/concepts/cookies#using-a-shared-parent-domain)