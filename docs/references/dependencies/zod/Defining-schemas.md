...
author: "default, only the output type is branded."
site: "Zod"
...
Introduced in `[email protected]`. Refer to the dedicated [Codecs](https://zod.dev/codecs) page for more information.
